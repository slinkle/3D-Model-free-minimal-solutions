...
function res=compute_Rt_2p(xjs,xis)
...
% %     sin_theta=Atheta(1);
% %     cos_theta=Atheta(2);
% %     esRij=[cos_theta, 0, sin_theta;...
% %          0           1,      0    ;...
% %          -sin_theta,0, cos_theta]; 
% %     estij=[sin_phi;0;cos_phi];
% %     Tij=[esRij,estij;0 0 0 1];
% %     Tji=inv(Tij);
% %     Rji=Tji(1:3,1:3);
% %     tji=Tji(1:3,4);
% %     Pi=[1;2;10];
...
% %         continue;
% %     end
% %     res=[res,[sin_theta;cos_theta;sin_phi;cos_phi]];
%     
...
% %         after_tr_lamdas=[after_tr_lamdas,[lamda1;lamda2]];
% %         all_tri_angles=[all_tri_angles,[sin_theta_phi;cos_theta_phi;sin_phi;cos_phi]];
%         AA=[cos_phi,-sin_phi;sin_phi,cos_phi];
%         Ab=[sin_theta_phi;cos_theta_phi];
%         Atheta=AA\Ab;
%         sin_theta=Atheta(1);
...
%     sin_phi=lamda1*xbar1(3)+lamda2*xbar2(3);
%     cos_phi=lamda1*xbar1(4)+lamda2*xbar2(4);
%     E=[0,cos_theta_phi,0;-cos_phi, 0, sin_phi; 0, sin_theta_phi, 0]
%     points1=xjs(1:2,:).';
%     points2=xis(1:2,:).';
